...
def run(file, dataName, updateInt, updateWindow, trainPerc=0.1):
    #a = 0.1
...
if __name__ == "__main__":
    ...
    files = ['Data/Helpdesk.csv', 'Data/BPIC11.csv', 'Data/BPIC12.csv']#['Data/BPIC15_1_sorted_new.csv', 'Data/BPIC15_2_sorted_new.csv', 'Data/BPIC15_3_sorted_new.csv', 'Data/BPIC15_4_sorted_new.csv', 'Data/BPIC15_5_sorted_new.csv',
             # 'Data/Helpdesk.csv', 'Data/BPIC11.csv', 'Data/BPIC12.csv']

    #names = ['BPIC15_1_OTF_OPT']
    names = ['Helpdesk_OTF_OPT', 'BPIC11_OTF_OPT', 'BPIC12_OTF_OPT'] #, 'BPIC15_2_OTF_OPT', 'BPIC15_3_OTF_OPT', 'BPIC15_4_OTF_OPT', 'BPIC15_5_OTF_OPT',
              # 'Helpdesk_OTF_OPT', 'BPIC11_OTF_OPT', 'BPIC12_OTF_OPT']
    for i in intervals:
        for w in windows:
            for f in range(len(files)):
                if i < 1000 and w < 1000:
                    run(files[f], names[f], i, w, trainPerc=0.5)
                elif i >= 1000:
                    run(files[f], names[f], i, w, trainPerc=0.5)
